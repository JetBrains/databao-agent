...
from databao._template_utils import make_jinja_package_environment
...
def read_prompt_template(relative_path: Path) -> jinja2.Template:
    ...
    if _jinja_prompts_env is None:
        _jinja_prompts_env = make_jinja_package_environment(package_name="databao.agents.lighthouse")
